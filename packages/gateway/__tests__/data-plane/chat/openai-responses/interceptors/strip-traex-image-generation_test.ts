...
} from '../../../../../src/data-plane/chat/openai-responses/interceptors/strip-traex-image-generation.ts';
...
const traexImageTool = (): OpenAIResponsesTool => ({
  type: 'namespace',
  name: 'image_gen',
    ...
    input: [
      {
        ...
        tools: [{
          ...
          tools: [
            (traexImageTool() as Extract<OpenAIResponsesTool, { type: 'namespace' }>).tools[0]!,
            functionTool('survivor') as Extract<OpenAIResponsesTool, { type: 'function' }>,
          ],
        }],
      },
  ...
  const payload: CanonicalOpenAIResponsesPayload = {
    ...
    tools: [
      functionTool('imagegen'),
      {
        ...
        tools: [(traexImageTool() as Extract<OpenAIResponsesTool, { type: 'namespace' }>).tools[0]!],
      },
      {
        type: 'namespace',
        name: 'image_gen',
